-- Truncate and re-seed featured books with multi-genre events (Travel, Concerts, Birthdays, Babies, Graduation)
...
('https://images.unsplash.com/photo-1519689680058-324335c77ebe?w=800&auto=format&fit=crop', 'Track cute baby steps and family milestones.', 4),
('https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=800&auto=format&fit=crop', 'Celebrate academic graduation achievement milestones.', 5);
